...
// @grant          unsafeWindow
// @run-at         document-end
// @downloadURL https://github.com/WayneFerdon/HVUT/raw/refs/heads/main/HV Utils 汉化.user.js
// @updateURL https://github.com/WayneFerdon/HVUT/raw/refs/heads/main/HV Utils 汉化.user.js
// ==/UserScript==
...
var $supply = {
  ...
  init_battle_node: function () {
    ...
    .hvut-bt-div > ul::before { content: attr(data-header); position: absolute; top: 0; width: inherit; border-bottom: 1px solid; background-color: #edb; font-size: 10pt; line-height: 20px; font-weight: bold; }

    .hvut-bt-sticky { position: absolute; top: -25.25px; left: 0; width: calc(100% - 1.1px); height: 0; border: unset!important; /*visibility: hidden;*/}
    ...
    .hvut-bt-bottom {min-height: 103.5px; top: 314px; height: fit-content; display: flex; flex-direction: row; flex-wrap: wrap; width: calc(100% - 0.1px); justify-content: space-between;}
